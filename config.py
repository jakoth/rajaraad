...
game_ID_writer.goto(7 * square_len, 4.5 * square_len)
...
black_piece = PhotoImage(file="black piece.gif").zoom(2, 2)
wn.addshape("black piece", turtle.Shape("image", black_piece))

white_piece = PhotoImage(file="white piece.gif").zoom(int(radius/5), int(radius/5))
#white_piece = PhotoImage(file="white piece.gif").zoom(int(radius), int(radius))
